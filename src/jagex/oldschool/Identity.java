...
public class Identity {
  ...
  public static String method486(long long_0) {
    if (long_0 > 0L && long_0 < 6582952005840035281L) {
      ...
      while (long_0 != 0L) {
        ...
        long_0 /= 37L;
        stringbuilder_0.append(Base37.ALPHABET[(int) (long_2 - long_0 * 37L)]);
      }

      return stringbuilder_0.reverse().toString();
    }
    return null;
  }
