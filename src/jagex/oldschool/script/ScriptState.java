...
public class ScriptState {
  ...
  public static void method559(final int int_0, final int int_1, final int int_2, final int int_3,
      final int int_4) {
    int int_5 = Class11.region.method372(int_0, int_1, int_2);
    int int_6;
    int int_7;
    int int_8;
    int int_9;
    ...
    int int_11;
    if (int_5 != 0) {
      int_6 = Class11.region.method376(int_0, int_1, int_2, int_5);
      int_7 = int_6 >> 6 & 0x3;
      int_8 = int_6 & 0x1F;
      int_9 = int_3;
      if (int_5 > 0) {
      ...
      final ObjectConfig objectcomposition_0 = Class2.getObjectDefinition(int_11);
      if (objectcomposition_0.mapSceneId != -1) {
        ...
        if (indexedsprite_0 != null) {
          final int int_12 = (objectcomposition_0.sizeX * 4 - indexedsprite_0.width) / 2;
          final int int_13 = (objectcomposition_0.sizeY * 4 - indexedsprite_0.height) / 2;
          indexedsprite_0.method933(int_12 + int_1 * 4 + 48,
              int_13 + 48 + (104 - int_2 - objectcomposition_0.sizeY) * 4);
        }
      } else {
        if (int_8 == 0 || int_8 == 2) {
          if (int_7 == 0) {
    ...
    int_5 = Class11.region.method377(int_0, int_1, int_2);
    if (int_5 != 0) {
      int_6 = Class11.region.method376(int_0, int_1, int_2, int_5);
      int_7 = int_6 >> 6 & 0x3;
      int_8 = int_6 & 0x1F;
      int_9 = int_5 >> 14 & 0x7FFF;
      final ObjectConfig objectcomposition_2 = Class2.getObjectDefinition(int_9);
      int int_14;
      if (objectcomposition_2.mapSceneId != -1) {
        ...
        if (indexedsprite_1 != null) {
          int_11 = (objectcomposition_2.sizeX * 4 - indexedsprite_1.width) / 2;
        ...
        final int[] ints_1 = ItemConfig.aSpritePixels5.buffer;
    ...
    int_5 = Class11.region.method375(int_0, int_1, int_2);
    if (int_5 != 0) {
      int_6 = int_5 >> 14 & 0x7FFF;
      final ObjectConfig objectcomposition_1 = Class2.getObjectDefinition(int_6);
      if (objectcomposition_1.mapSceneId != -1) {
        ...
        if (indexedsprite_2 != null) {
          int_9 = (objectcomposition_1.sizeX * 4 - indexedsprite_2.width) / 2;
          final int int_15 = (objectcomposition_1.sizeY * 4 - indexedsprite_2.height) / 2;
          indexedsprite_2.method933(int_9 + int_1 * 4 + 48,
              int_15 + (104 - int_2 - objectcomposition_1.sizeY) * 4 + 48);
          return;
        }
      }
    }
